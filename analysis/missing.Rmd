...
We are shrinking the wavelet coefficients($\tilde\mu$) not $y$! If we set the missing data's $s_t$ very large, then all the variance of corresponding wavelet coefficients that involve missing data are very large. Thus, a large number of wavelet coefficients(essentially differences) are shirnked to zero, including those should not be done so.
...
Can we munually choose what levels to shrink using large variance?
