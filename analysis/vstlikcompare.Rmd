...
x=rpois(length(m),lamda)
fit = smash.gen.poiss(x,transformation = 'lik_expansion',method = 'smash',ash.pm = TRUE,nug.init = 0)
fit2 = smash.gen.poiss(x,transformation = 'vst',method = 'smash',ash.pm = TRUE)
plot(x,col='grey80')
...
x=rpois(length(m),lamda)
fit = smash.gen.poiss(x,transformation = 'lik_expansion',method = 'smash',ash.pm = TRUE,nug.init = 0)
fit2 = smash.gen.poiss(x,transformation = 'vst',method = 'smash',nug.init = 0)
plot(x,col='grey80')
lines(m+sigma^2,col='grey50')
lines(fit$lambda.est,col=1,lwd=2)
lines(fit2$lambda.est,col=2,lwd=2)
