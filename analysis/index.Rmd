...
This [R package](https://github.com/DongyueXie/smashrgen) contains functions used in this project.
...
We treat unevenly spaced data as missing and set them to 0 with corresponding standard error $10^6$. The idea is that if standard error is very big then value of y becomes irrelevant.
