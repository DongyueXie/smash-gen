...
3. [A robust version of smash-gen](robustalgo.gtml): set the highest resolution wavelet coeffs to 0.
4. [Poisson nugget simulation](nuggetunkown.html): assume $\sigma$ is unknown.
